...
Pero eso queda como desafío para el lector :). El código completo de la clase se los dejo en este [Gist](https://gist.github.com/Gazer/6702455190adefef62bf721e9c5be0ae).
